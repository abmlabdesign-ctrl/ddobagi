    ...
    questions: [
      {
        id: 'sm-1',
        type: 'write',
        promptLabel: 'Write this in Korean',
        prompt: 'I went to school yesterday.',
        blanks: [['어제 학교에 갔어요', '어제 학교에 갔습니다']],
        explanation: 'Past tense takes -았/었어요, so 가다 becomes 갔어요',
      },
      {
        id: 'sm-2',
        type: 'write',
        promptLabel: 'Write this in Korean',
        prompt: "I'll eat here.",
        blanks: [['여기서 먹을게요', '여기서 먹겠습니다']],
        explanation: '-을게요 is the ending for something you have just decided to do',
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: 'pr-1',
        type: 'write',
        promptLabel: 'Say this politely',
        prompt: 'You are asking a shop owner where they are going.',
        source: '어디 가?',
        blanks: [['어디 가요', '어디 가세요']],
      ...
      },
      {
        ...
        type: 'write',
        promptLabel: 'Say this politely',
        prompt: 'You are asking your professor whether they have eaten.',
        source: '밥 먹었어?',
        blanks: [['식사하셨어요', '밥 먹었어요', '진지 드셨어요']],
        explanation: 'To someone senior, 식사하시다 is the respectful verb for 먹다',
      },
    ],
  },
  {
